...
public abstract class EntityLivingBase extends Entity
{
    ...
    public boolean canEntityBeSeen(Vec3d pos)
    {
        return this.world.rayTraceBlocks(new Vec3d(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), new Vec3d(pos.xCoord, pos.yCoord + (double)this.getEyeHeight(), pos.zCoord), false, true, false) == null;
    }
